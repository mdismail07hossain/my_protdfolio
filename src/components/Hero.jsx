      ...
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
          ...
          <div>
              <h1 className={`${styles.heroHeadText} text-white`}>
                Hi, I'm <br /><span className='text-[#915eff]'>MD ISMAIL HOSSAIN</span>
              </h1>
              <div className=' py-1'>
              <p className={` text-4xl font-semibold  mt-1 text-white-100 flex-nowrap`}> Web Developer</p> <br />
              ...
              <div className="flex gap-4 mt-5">
                <a
                  href="https://github.com/mdismail07hossain"
                  target="_blank"
                ...
                <a
                  href="mailto:mdismail07.hossain@gmail.com"
                  target="_blank"
                  className="bg-gray-800 p-4 rounded-xl text-white hover:bg-gray-700 transition"
                >
                  <FaEnvelope size={30} />
